...
const About = () => (
  <section id="about" className={styles.page} aria-labelledby="about-title">
    <div className={styles.main}>
      <header className={`page-section-header ${styles.pageHeader}`}>
          ...
          <div className={styles.aboutCopy}>
            ...
            <div className={styles.bio}>
              <p>
                ...
                thoughtful user experiences and clean, maintainable code. Over
                the past four years, I’ve worked across the entire frontend
                development process, collaborating with product teams to
                transform research into intuitive digital experiences, designing
                interfaces, and building scalable, accessible, and performant
                applications.
              </p>
              <p>
                Before I learned to code, I studied and worked in the visual
                arts. I started working with ceramics in high school, earned a
                BFA in Studio Art in college, and spent the first few years of
                my career at a bronze fine art foundry. It was there that I
                discovered web development and realized programming was simply
                another creative medium. The same excitement I found in making
                art, I found in building software, except now I could bring
                ideas to life instantly. That realization completely changed the
                direction of my career, and I’ve been building software ever
                since.
              </p>
              <p>
                Outside of work, I enjoy fly fishing, Brazilian Jiu-Jitsu,
                snowboarding, gardening, and spending time outdoors. Whether I’m
                exploring or working on a new creative project, I find that
                having interests beyond software helps me stay curious and
                brings fresh perspective back into my work.
              </p>
              <p>
                If you’ve made it this far, thanks for stopping by. Whether
                you’re hiring, building something interesting, or just want to
                connect, I’d love to hear from you. Don’t be a stranger!
              </p>
            </div>
          </div>
